...
<div class="container">
 ...
 <div class="right-side">
  <div class="new">Ζητήστε Προσφορά</div>
...
.card {
  ...
  align-items: center;
  -webkit-box-shadow: 9px 9px 9px -2px rgba(77, 120, 200, 0.72);
  -moz-box-shadow: 9px 9px 9px -2px rgba(77, 120, 200, 0.72);
  -webkit-box-shadow: 9px 9px 9px -2px rgba(77, 106, 200, 0.72);
}
...
.buttons {
  ...
  height: 8px;
  background-color: #2f55d4;
  box-shadow: 0 -10px 0 0 #2f55d4, 0 10px 0 0 #2f55d4;
  border-radius: 50%;
  margin-top: 5px;
